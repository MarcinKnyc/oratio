...
namespace Oratio.Areas.Identity.Pages.Account
{
    public class RegisterParishModel : PageModel
    {
        ...
        private readonly IUserStore<OratioUser> _userStore;
        ...
        private OratioUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<OratioUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(OratioUser)}'. " +
                    $"Ensure that '{nameof(OratioUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<OratioUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<OratioUser>)_userStore;
        }
    }
}
