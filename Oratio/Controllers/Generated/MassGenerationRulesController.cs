...
namespace Oratio.Controllers.Generated
{
    public class MassGenerationRulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RuleTerminationTime,DayOfWeek,IsActive,Time,RuleStartTime,Id,OwnerId")] MassGenerationRule massGenerationRule)
        {
