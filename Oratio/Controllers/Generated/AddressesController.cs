...
namespace Oratio.Controllers.Generated
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StreetName,StreetNumber,City,ZipCode,ChurchId")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,StreetName,StreetNumber,City,ZipCode,ChurchId")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
